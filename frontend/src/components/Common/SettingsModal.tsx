...
import { X, Settings, Save, Database, ExternalLink, CheckCircle } from 'lucide-react';
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="p-3.5 rounded-xl bg-slate-900/60 border border-slate-800/80">
            <p className="text-[11px] text-slate-500 leading-relaxed">
              ...
              All settings and saved connection profiles are stored in your browser's{' '}
              <code className="text-brand-400 bg-slate-800/80 px-1 rounded">localStorage</code>.
              No external database is required. Data is private to this browser.
            </p>
          </div>
        </div>
